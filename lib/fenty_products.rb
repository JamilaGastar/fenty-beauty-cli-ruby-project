...
class FentyProducts
    ...
    FENTY_BEAUTY_API_URL = "https://makeup-api.herokuapp.com/api/v1/products.json?brand=fenty"
    ...
    def self.list_products_by_product_type(product_type)
        url = FENTY_BEAUTY_API_URL + product_type
        uri = URI.parse(url)
...
# fenty_products = fenty_products.new.get_makeup_products
# puts fenty_products
